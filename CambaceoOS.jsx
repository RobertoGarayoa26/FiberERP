...
export const CambaceoOSGrid = () => {
  ...
  // Función para guardar un registro con axios y token
  ...
  // Función para eliminar un registro con axios y token
  ...
  // Función para actualizar un registro con axios y token
  const processRowUpdate = async (newRow, oldRow) => {
    try {
      ...
      return response.data; // o response.data.orden según API
    } catch (error) {
  ...
  // Actualizar modelo de edición
  const handleRowModesModelChange = (newModel) => {
    setRowModesModel(newModel);
  };

  // Detectar filtro tipo de servicio según URL
  ...
  // Filtrar registros según tipo de servicio
